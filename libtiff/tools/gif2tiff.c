#ifndef lint
static char rcsid[] = "$Header: /usr/people/sam/tiff/tools/RCS/gif2tiff.c,v 1.9 93/08/26 17:12:53 sam Exp $";
#endif
 ...
 */
int
process(register code, unsigned char** fill)
{
    int incode;
