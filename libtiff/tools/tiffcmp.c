#ifndef lint
static char rcsid[] = "$Header: /usr/people/sam/tiff/tools/RCS/tiffcmp.c,v 1.17 93/08/26 15:11:24 sam Exp $";
#endif
...
tiffcmp(TIFF* tif1, TIFF* tif2)
{
	...
	buf2 = (unsigned char *)malloc(size2 = TIFFScanlineSize(tif2));
...
{
	register int mask1, mask2, s, ppb, bps;
